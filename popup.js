...
function renderCurrentCard() {
  ...
  document.getElementById('curTips').innerHTML = cur.tips.map(t =>
    `<div class="tip-item"><span class="tip-dot">◆</span><span>${t}</span></div>`
  ).join('');
}
